        ...
        <div className="container">
          <div className="company__style">
            <div className="company__content1">
              <h1 className="company__content1__title">О компании</h1>
              <div className="company__content1__cards">
                <div className="company__content1__card">
                  <h2 className="company__content1__card__text">170+</h2>
                  <p className="company__content1__card__par">Товаров</p>
                </div>
                <div className="company__content1__card">
                  <h3 className="company__content1__card__text">1000+ </h3>
                  <p className="company__content1__card__par">
                    Довольных покупателей
                  </p>
                </div>
                <div className="company__content1__card">
                  <h3 className="company__content1__card__text">170+</h3>
                  <p className="company__content1__card__par">Товаров</p>
                </div>
              </div>
            </div>
            <p className="company__style__par">
